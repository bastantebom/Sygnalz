            ...
            if($cusId==$resultData['user_id']){
              $finaldat.= "<tr>
               ...
               $finaldat.= "<tr>    
                        ...
                        <td colspan='2'><img src='images/trash.png' alt='$resultData[user_id]' title='' class='deleteUser' onclick='delCustomer(this.alt)'  border='0' /></td>
                    </tr>";
            }
          }
          return $finaldat;
          ...
          while($resultData=$resultAuthUser->fetch_array(MYSQLI_ASSOC)){
            if($ven_id==$resultData['user_id']){
              $finaldat.= "<tr>
               ...
               $listExpertise = $this->getListExpertise($conn,$resultData['user_id'],$resultData['vendor_expertise']);
               ...
               $finaldat.= "<tr>    
                        ...
                        <td colspan='2'><img src='images/trash.png' alt='$resultData[user_id]' title='' class='deleteUser' onclick='delVendor(this.alt)'  border='0' /></td>
                    </tr>";
            }
          }
          return $finaldat;
