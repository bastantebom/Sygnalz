...
function payVendor(id,vendor){
    
    var r=confirm("Are you sure you want to clear balance for this Vendor?");
        if (r==true){
            var uid=$(".userId").val();
            $.post("_action/action_updatePayment.php",{direct_access:id,userid:uid,payment:id,vendor:vendor},
...
function refreshPaymentList(){
    //alert("Perform refresh");
    $.post("_action/action_getPaymentList.php",{},
...
function editVendor(vend_id){
    $.post("_action/action_updateVendor.php",{vend_id:vend_id},
            function(data){
                $("#vendorList").html(data);
...
function saveupVendor(vend_id){
    //alert(vend_id);
           ...
           $("#vexpertise :checked").each(function() {
            ...
            if( vendor!= "" && price != "" && temp != ""){
                $.post("_action/action_saveUpVendor.php",{direct_access: action_validator,vendor:vendor,price:price, temp:temp},
